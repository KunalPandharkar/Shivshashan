  ...
  return (
    ...
    (function (a, b) {
      ...
      function r(a) {
        ...
        return (
          s.shivCSS &&
            ...
            (c.hasCSS = !!l(
              a,
              "article,aside,dialog,div,div,footer,header,hgroup,main,nav,div{display:block}mark{background:#FF0;color:#000}template{display:none}"
            )),
          k || q(a, c),
          a
        );
      ...
      var s = {
        elements:
          d.elements ||
          "abbr article aside audio bdi canvas data datalist details dialog div div footer header hgroup main mark meter nav output progress div summary template time video",
        version: c,
        shivCSS: d.shivCSS !== !1,
